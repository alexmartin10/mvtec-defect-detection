...
print(f"large lenght : {len(score_broken_large)}")
print(f"small lenght : {len(score_broken_small)}")
print(f"contamination lenght : {len(score_contamination)}")
print(f"good lenght : {len(score_good)}")
...
# AUROC broken_large
labels = [0] * len(score_good) + [1] * len(score_broken_large)
scores = score_good + score_broken_large
print(f" Score broken_large : {roc_auc_score(labels, scores)}")

# AUROC broken_small
labels = [0] * len(score_good) + [1] * len(score_broken_small)
scores = score_good + score_broken_small
print(f" Score broken_small : {roc_auc_score(labels, scores)}")

# AUROC contamination
labels = [0] * len(score_good) + [1] * len(score_contamination)
scores = score_good + score_contamination
print(f" Score contamination : {roc_auc_score(labels, scores)}")
